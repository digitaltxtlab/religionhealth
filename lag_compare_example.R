X<-subset(data,Complete<3 & is.na(PosAffekt)==FALSE,select =c("deltagerNr","Complete","PosAffekt","perPrayer"))
data[,'deltagerNr']
...
mdl 
# tolkning af signifikante resultater: positivt lag, betyder at x forudsiger af y med maksimalt på lag. negativt lag så forudsiger y , x.
